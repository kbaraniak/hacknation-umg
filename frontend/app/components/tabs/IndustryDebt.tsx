...
export default function IndustryDebt() {
    ...
    return (
        <div className="rounded-md">
            <h1 className="text-2xl font-bold mb-4 text-gray-900">Zadłużenie Branży</h1>
            <p className="mb-4 text-gray-700">Poziom i dynamika zadłużenia w wybranych branżach.</p>
