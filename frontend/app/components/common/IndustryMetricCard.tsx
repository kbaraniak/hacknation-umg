...
export default function IndustryMetricCard({ 
    ...
    return (
        <div className="p-3 sm:p-4 bg-white rounded-lg border border-gray-300">
            ...
            <div className="mt-3 space-y-1 bg-gray-50 p-2 sm:p-3 rounded border border-gray-200">
                {data.map(d => (
                    <div key={d.pkdCode} className="text-xs sm:text-sm text-gray-900">
